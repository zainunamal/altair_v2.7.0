                                ...
                                <?php foreach ($item['submenu'] as $submenu_item) { ?>
                                    <?php if (isset($submenu_item['items'])) { ?>
                                        ...
                                        <?php foreach($submenu_item['items'] as $section_item) { ?>
                                            <li<?php if($sPage == $section_item['url']) { echo ' class="act_item"'; }; ?>><a href="<?php echo $section_item['url']; ?>.html"><?php echo $section_item['title']; ?></a></li>
                                        <?php }; ?>
                                    <?php } else { ?>
                                        <li<?php if($sPage == $submenu_item['url']) { echo ' class="act_item"'; }; ?>><a href="<?php echo $submenu_item['url']; ?>.html"><?php echo $submenu_item['title']; ?></a></li>
                                    <?php }; ?>
                                <?php }; ?>
                            </ul>
                        <?php }; ?>
