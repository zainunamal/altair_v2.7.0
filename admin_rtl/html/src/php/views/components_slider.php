    ...
    <div id="page_content_inner">
        ...
        <div class="md-card uk-margin-large-bottom">
            <div class="md-card-content">
                ...
                <div class="uk-slidenav-position" data-uk-slider="{autoplay: true,autoplayInterval: '5000'}" dir="ltr">
...
<?php } ?>
        ...
        <div class="uk-slidenav-position uk-margin-large-bottom" data-uk-slider="{center:true,autoplay: true,autoplayInterval: '3000'}" dir="ltr">
...
<?php } ?>
        ...
        <div class="md-card uk-margin-large-bottom">
            <div class="md-card-content">
                ...
                <div class="uk-slidenav-position" data-uk-slider dir="ltr">
